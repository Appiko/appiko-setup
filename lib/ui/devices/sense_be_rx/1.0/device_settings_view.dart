...
class _DeviceSettingsViewState extends State<DeviceSettingsView>
            ...
            child: Scaffold(
              body: RubberBottomSheet(
                ...
                upperLayer: DeviceSettingProfilesLayer(
                  shouldSave: locator<SenseBeRxService>().shouldSave,
                      ...
                      : isDisconnected
                          ...
                          : () async {
                              await locator<BluetoothIOService>().write(
                                  pack(locator<SenseBeRxService>().structure));
  ...
  closeConnection(BuildContext context, bool isDisconnected) {
    ...
    } else if (locator<SenseBeRxService>().shouldSave && isDisconnected) {
      showDiscardDialog(
        context: context,
        onDiscardPressed: () {
          Navigator.popUntil(context, ModalRoute.withName('/'));
          ...
          SliverAppBar(
            ...
            actions: <Widget>[
                ...
                onPressed: () {
                  ...
                  showDialog(
                      ...
                      builder: (context) => DeviceInfoDialog(
                            ...
                            batteryType: locator<SenseBeRxService>()
                                .structure
                                .batteryType,
                          ));
                },
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.pushNamed(context, '/br/device-info');
                },
              ),
            ],
            bottom: TabBar(
